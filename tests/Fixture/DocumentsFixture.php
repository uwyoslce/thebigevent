...
class DocumentsFixture extends TestFixture
{
    ...
    public $fields = [
        'document_id' => ['type' => 'integer', 'length' => 11, 'unsigned' => false, 'null' => false, 'default' => null, 'comment' => '', 'autoIncrement' => true, 'precision' => null],
        ...
        '_constraints' => [
            'primary' => ['type' => 'primary', 'columns' => ['document_id'], 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
    ...
    public $records = [
        [
            ...
            'created' => '2016-09-14 01:07:29',
            'modified' => '2016-09-14 01:07:29'
        ],
    ];
}
