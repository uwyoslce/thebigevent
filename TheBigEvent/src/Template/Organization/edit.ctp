...
<div class="organization form large-9 medium-8 columns content">
    ...
    <fieldset>
        ...
        <?php
            ...
            echo $this->Form->input('access_code');
            echo $this->Form->input('flag_indiv');
            echo $this->Form->input('flag_indiv_split');
            echo $this->Form->input('flag_split');
            echo $this->Form->input('flag_fishcamp');
            echo $this->Form->input('flag_backup');
            echo $this->Form->input('flag_corps');
        ?>
    </fieldset>
