...
class TodosFixture extends TestFixture
{
    ...
    public $fields = [
        'todo_id' => ['type' => 'integer', 'length' => 11, 'unsigned' => false, 'null' => false, 'default' => null, 'comment' => '', 'autoIncrement' => true, 'precision' => null],
        ...
        '_constraints' => [
            'primary' => ['type' => 'primary', 'columns' => ['todo_id'], 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
    ...
    public $records = [
        [
            ...
            'due' => '2016-07-23 19:12:03',
            'completed' => 1,
            'created' => '2016-07-23 19:12:03',
            'modified' => '2016-07-23 19:12:03'
        ],
    ];
}
