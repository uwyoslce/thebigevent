...
<div class="jobs view large-9 medium-8 columns content">
	...
	<div class="row">
		...
		<div class="column large-12 text-center">
			...
			<?php if( $user->participating ): ?>
				...
				<h2 class="">You are participating in The Big Event!</h2>
				<p>Stay connected to your email for more information leading up to The Big Event!</p>
			<?php else: ?>
				<i class="fa fa-question text-warning fa-5x"></i>
				<h2 class="">Are you participating in The Big Event?</h2>
				<p>If you are participating in The Big Event, click this button!</p>
				<p><?= $this->Html->link(__("I am participating in The Big Event!"), ['action' => 'participate'], [
		...
		<div class="column large-4 text-center">
			...
			<p>
				<?= __('A completed profile will help The Big Event committee match you to the best job for you.') ?>
			</p>
		</div>
		<div class="column large-4 text-center">
	...
	<div class="row">
		...
		<div class="column large-12">
			<p>We use your name to personalize the site and address you in emails.  Your name is also used for signing electronic documents.</p>
		</div>
		<div class="column large-12">
	...
	<div class="row">
		<div class="column large-6">
			...
			<p>We may need to send important messages to you about The Big Event via this email address.</p>
		</div>
		<div class="column large-6">
	...
	<div class="row">
		...
		<div class="column large-4">
			...
			<p>
				The Big Event t-shirts are available on a first-come-first-served basis.
		...
		<div class="column large-4">
			<?= $this->Form->control('transportation', [
				'options' => [
					'cannot_drive' => __("I cannot drive during The Big Event"),
					'can_drive' => __("I can drive during The Big Event"),
				],
