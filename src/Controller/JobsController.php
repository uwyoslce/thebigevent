...
class JobsController extends AppController
{
	...
	{
		$jobsOpenDateTime = new \Cake\Chronos\Chronos(Configure::read('TheBigEvent.jobs.openDate'), $this->time_zone);
		$jobsCloseDateTime = new \Cake\Chronos\Chronos(Configure::read('TheBigEvent.jobs.closeDate'), $this->time_zone);
		$now = new \Cake\Chronos\Chronos();
		$jobCount = $this->Jobs->find()->count();
